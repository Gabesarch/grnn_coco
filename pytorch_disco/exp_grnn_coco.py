...
exps['replica_carla_multiview_training'] = [
    'clevr_sta', # mode
    'carla_and_replica_train', # dataset
    '200k_iters',
    'lr3',
    'B2',
    'train_feat',
...
exps['replica_multiview_trainer2'] = [
    'replica_sta', # mode
...
# groups['carla_and_replica_train'] = ['dataset_name = "replica"',
#                              'H = %d' % 256,
#                              'W = %d' % 256,
#                              'N = %d' % 6,
...
#                              f'dataset_list_dir = "/projects/katefgroup/viewpredseg/"',
#                              f'dataset_location = "/projects/katefgroup/viewpredseg/"',
#                              f'root_dataset = "/projects/katefgroup/viewpredseg/"',
#                              'dataset_format = "npz"'
# ]

groups['replica_train'] = ['dataset_name = "replica"',
                             'H = %d' % 256,
                             'W = %d' % 256,
                             'N = %d' % 6,
                             'trainset = "train"',
                            #  'testset = "be_lv"',
                             'root_keyword = "home"',                             
                             'dict_distance_thresh = 1500',                             
                             f'dataset_list_dir = "/projects/katefgroup/viewpredseg/replica_all_obj_processed/npy"',
                             f'dataset_location = "/projects/katefgroup/viewpredseg/replica_all_obj_processed/npy"',
                             f'root_dataset = "/projects/katefgroup/viewpredseg/replica_all_obj_processed/npy"',
                             'dataset_format = "npz"'
]
...
#     'trainset_seqlen = %d' % 2, 
#     'dataset_location = "/projects/katefgroup/viewpredseg/"',
