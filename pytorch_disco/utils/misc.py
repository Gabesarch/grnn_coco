...
def collect_object_info(lrtlist_camRs, tidlist_s, scorelist_s, K, boxlist_camRs=None, mod='', do_vis=True, summ_writer=None):
...
def rescore_lrtlist_with_pointcloud(lrtlist_camX, xyz_camX, scorelist, thresh=1.0):
    # boxlist_camR is B x N x 9
