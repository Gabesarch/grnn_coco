...
class Summ_writer(object):
    ...
    def summ_gif(self, name, tensor, blacken_zeros=False):
        ...
        # print(name, video_to_write.shape)

        if video_to_write.shape[1]==1:
            # print("add_image")
            self.writer.add_image(name, video_to_write.squeeze(), global_step=self.global_step)
        else:
